...
<body>
	<%-- 
		request(요청) : 클라이언트가 요청한 정보를 담고 있다.(파라미터도 가지고 있다.)
		** request 생명주기는 response(응답) 하면 끝난다.
		
		request 가 가지고 있는 정보들 
			1. 클라이언트의 정보 및 서버정보를 얻을수 있는 메서드 제공
			- getRemoteAddr() / getContentLength() / getCharacterEncoding()
			- getContentType() / getProtocol() / getServerPort()
		 ...
		 ** 2. 파라미터의 정보 제공 
			...
			- getParameterNames(String name) : Enumeration<String>
